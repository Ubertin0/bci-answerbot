      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-10">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
          ...
          <div className="flex-1 min-w-0">
            ...
            <h3 className="fade-blur-element font-heading font-bold text-brand-base text-xl mb-2">
              Евгений Баландин
            </h3>

            <p className="fade-blur-element font-mono text-warmgray/60 text-sm mb-6">
              Платформенный инженер и архитектор BCI.
            </p>

            <p className="fade-blur-element font-mono text-warmgray/80 text-sm leading-relaxed mb-8 max-w-[640px]">
            ...
            <div className="fade-blur-element mb-8">
